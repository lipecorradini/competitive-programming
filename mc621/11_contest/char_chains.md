...
// suffix tree implementation extracted from https://github.com/Rerito/suffix-tree/blob/master/suffixtree.h
...
#endif // _SUFFIX_TREE_HPP_INCLUDED_      new_t.sub.l += delta+1;
